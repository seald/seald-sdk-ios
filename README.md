...
The current version is `0.8.0-beta.8`.
...
You can find the license information of Open Source libraries used in Seald SDK for mobile at <https://download.seald.io/download/mobile_dependencies_licenses_0.8.0-beta.8.txt>.
